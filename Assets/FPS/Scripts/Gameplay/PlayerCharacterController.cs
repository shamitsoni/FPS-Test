    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        void OnDie()
        {
          ...
          //  EventManager.Broadcast(Events.PlayerDeathEvent);
            ...
            StartCoroutine(RespawnAfterDelay(2f)); // wait 2 seconds
        }
        ...
        IEnumerator RespawnAfterDelay(float delay)
        {
            ...
            // Respawn at spawn point or fallback
            Transform spawn = GameObject.FindWithTag("Respawn")?.transform;
            transform.position = spawn ? spawn.position : Vector3.zero;

            // Reset velocity
            CharacterVelocity = Vector3.zero;

            // Re-equip starting weapon
