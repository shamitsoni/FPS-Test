...
namespace Unity.FPS.Gameplay
{
    public class ProjectileStandard : ProjectileBase
    {
        ...
        bool hasHit = false; // ✅ Added guard flag
        ...
        void Update()
        {
            if (hasHit) return; // ✅ Prevent any more updates after a hit
        ...
        void OnHit(Vector3 point, Vector3 normal, Collider collider)
        {
            ...
            else
            {
                ...
                if (damageable)
                {
                    ...
                    // ✅ Only count hits if the shooter is the player
                    if (HitCounter.Instance != null && m_ProjectileBase.Owner.CompareTag("Player"))
                        HitCounter.Instance.AddHit(m_ProjectileBase.Owner, collider.gameObject);
                }
            }
